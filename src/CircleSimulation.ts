export class CircleSimulation {
  ...
  private VELOCITY_DECAY = 0.9995; // Changed from 0.998 to 0.9995 for less velocity loss
  ...
  private update() {
    ...
    if (distance >= this.CIRCLE_RADIUS - this.ballRadius) {
      ...
      const restitution = 0.95; // Changed from 0.9 to 0.95 for more bouncy collisions
